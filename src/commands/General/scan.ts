...
export class ScanCommand extends Command {
  ...
  override async chatInputRun(interaction: Command.ChatInputCommandInteraction) {
    ...
    switch (subcommand) {
      case "salons":
        return this.scanChannels(interaction);
      case "roles":
        return this.scanRoles(interaction);
      case "tout":
  ...
  private async scanChannels(interaction: Command.ChatInputCommandInteraction) {
  ...
  private async scanRoles(interaction: Command.ChatInputCommandInteraction) {
    const guild = interaction.guild!;
  ...
  private async scanAll(interaction: Command.ChatInputCommandInteraction) {
    const guild = interaction.guild!;
